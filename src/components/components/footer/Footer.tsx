			...
			<div className='container_'>
				<div className='flex items-center justify-between pb-[40px] mb-[50px] border-b-[1px]  border-[#cbcbcb] max-[620px]:block'>
					...
					<ul className='flex items-center gap-[35px]  font-medium text-[18px] duration-300 transition-colors max-[450px]:gap-[25px] max-[620px]:pt-[10px]'>
						...
						<li className='hover:text-[#5C4EAE] text-[#606060]'>
							<a href=''>Blog</a>
						</li>
						<li className='hover:text-[#5C4EAE] text-[#606060]'>
							<a href=''>Pricing</a>
				...
				<div className='flex items-center justify-between max-[620px]:flex-col-reverse'>
					<div className='font-[500] text-[17px] text-[#999999] '>© 2024 EATLY All Rights Reserved.</div>
					<div>
							...
							<li>
								<a href='/' >
									...
									>
										...
										></path>
										<path className='fill-[#606060]  hover:fill-[#6C5FBC]' d='M17.7181 4.96758C17.7181 5.67731 17.1605 6.28566 16.4507 6.28566C15.741 6.28566 15.1327 5.67731 15.1834 4.96758C15.1834 4.25785 15.741 3.7002 16.4507 3.7002C17.1605 3.7002 17.7181 4.25784 17.7181 4.96758Z'></path>
									</svg>
								</a>
							</li>
							<li>
